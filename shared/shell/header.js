...
export function renderHeader(container) {
  ...
  let homeHref = "/";
  // public/images/logo.png 사용 (모든 경로에서 접근 가능)
  ...
  const nicknameMobile = container.querySelector(
    "#headerAccountNicknameMobile"
  );
  ...
  document.addEventListener("DOMContentLoaded", async () => {
    ...
    if (container) {
      ...
      try {
        ...
        const nicknameMobile = document.getElementById(
          "headerAccountNicknameMobile"
        );
