...
## [v0.2.0] - 2025-12-31 (First Playable Loop)

- **Features**:
  - **Full Game Loop**: Matchmaking -> Event Confirmation -> Simulation (Results) -> Season Update.
  - **Auto Match**: One-click matchmaking with smart(ish) greedy logic.
  - **Event View**: Detailed result screen with "return to home" logic.
  - **Bilingual Nicknames**: Support for KO/EN nicknames with dual display.
- **UI Improvements**:
  - Financial localized formatting (KRW units, e.g. "1.2억원").
  - Enhanced Fighter Selection Modal (Stats toggle).
  - Missing KO translations added.
